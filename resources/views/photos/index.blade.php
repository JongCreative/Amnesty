...
@section('content')
    ...
    <div class="grid_container">
        <div class="gallery_card">
            ...
            <div class="card_phototitle">Dit is een mooie foto</div>
            <div class="card_creator">Pietje Puk</div>
        </div>
        <div class="gallery_card">
            <img src="{{url('/img/devlucht.jpg')}}" alt="">
            <div class="card_phototitle">Dit is een mooie foto</div>
    ...
    @endsection
       ...
       {{--<article class="content_container flex_column">
        ...
        <div class="content_positioning cards_container gallery_card_container">
